...
router.put("/:id", verifyUserRole, async (req, res) => {
  try {
    ...
    post.TwitterLink = req.body.TwitterLink;
...
router.post("/paragraphwithIa", async (req, res) => {
  try {
    ...
    {CATEGORIA}
    {HASHTAGS}
    No existe oportunidad de responder de ninguna otra forma posible , si no existe el contenido de algo que te envie, dentro de la respuesta , deberas colocar como undefined. necesito que los separes para que pueda renderizarlos en reactjs`;
